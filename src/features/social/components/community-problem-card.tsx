...
import { CommunityProblemDialog } from "./community-problem-dialog";
import { Button } from "@/components/ui/button";
import { EditIcon, Trash2Icon } from "lucide-react";
import { DeleteCommunityProblemButton } from "./delete-community-problem-button";
...
export const CommunityProblemCard = ({
  ...
  const isCurrentUserAuthor = communityProblem.isCurrentUserAuthor;
        ...
        <div className="flex items-center gap-2 w-full min-w-0">
          ...
          {isCurrentUserAuthor && (
            <div className="flex items-center gap-2">
              <CommunityProblemDialog existingProblem={communityProblem}>
